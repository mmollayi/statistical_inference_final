...
```{r, fig.width=6, fig.asp=0.8, fig.align="center", fig.cap = "Figure 1: Both supplement and dose seems to make a difference in odontoblast length."}
ToothGrowth %>%
...
```{r, fig.width=6, fig.asp=0.8, fig.align="center", fig.cap="Figure 2: Daily dose modifies the relationship between supplement and odontoblast length."}
